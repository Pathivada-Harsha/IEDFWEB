        ...
        <div className="Portfolio-portfolio">
            ...
            <section className="Portfolio-companies" data-section="companies">
                <div className="Portfolio-container">
                    ...
                    <div className={`Portfolio-companies-grid ${visibleSections.has("companies") ? "Portfolio-animate-in" : ""}`}>
                        {portfolioCompanies.map((company, index) => (
                            ...
                            >
                                <div className="Portfolio-company-image">
                                    <img src={company.image || "/placeholder.svg"} alt={company.name} />
                                    <div className="Portfolio-company-overlay">
                                        <div className="Portfolio-company-locations">
                                            {company.locations.map((location, idx) => (
                                                <span key={idx} className="Portfolio-location-tag">
                                                    {location}
                                                </span>
                                            ))}
                                        </div>
                                ...
                                <div className="Portfolio-company-content">
                                    <div className="Portfolio-company-header">
                                        <h3 className="Portfolio-company-name">{company.name}</h3>
                                        <span className="Portfolio-company-sector">{company.sector}</span>
                                    </div>

                                    <p className="Portfolio-company-description">{company.description}</p>

                                    <div className="Portfolio-company-highlights">
                                        {company.highlights.map((highlight, idx) => (
                                            <span key={idx} className="Portfolio-highlight-tag">
                                                {highlight}
                                            </span>
                                        ))}
                                    </div>

                                    <div className="Portfolio-company-footer">
                                        <span className="Portfolio-company-website">{company.website}</span>
                                        <button className="Portfolio-learn-more-btn">Learn More</button>
                                    </div>
                                </div>
                            </div>
                        ))}
