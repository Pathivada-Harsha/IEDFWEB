...
import team1 from "./../images/Team/Bhanuchandran.jpg"
import team2 from "./../images/Team/RaviTheja.jpg"
import team3 from "./../images/Team/ArunKumar.png"
      ...
      <section className="team-circle-section" data-section="circle">
        <div className="team-wrapper">
          <div className="team-header-section">
            <h2 className="team-main-title">Meet Our Experienced Team</h2>
            {/* <p className="team-main-description">Meet our experienced leaders driving innovation and growth</p> */}
          </div>
